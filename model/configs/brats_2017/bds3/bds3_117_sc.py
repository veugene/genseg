# bds3_116_sc (bds3_106_sc) with a bigger discriminator
...
def build_model(lambda_disc=3,
    ...
    D = 768 # Largest conv layer size in discriminator.
    #image_size = (4, 77, 120, 60)
    #image_size = (4, 100, 150, 60)
    image_size = (4, 80, 120, 60)
    #image_size = (4, 70, 140, 60)
    ...
    discriminator_kwargs = {
        ...
        'num_channels_list'   : [D//8, D//4, D//2, D],
        'num_scales'          : 3,
        'normalization'       : layer_normalization,
        'norm_kwargs'         : None,
        'kernel_size'         : 3,
