...
def build_model():
    ...
    class generator(nn.Module):
        ...
        def __init__(self, d=128):
            ...
            self.conv2 = nn.Conv2d(d*8, d*4, 5, 1, 2)
            self.conv2_bn = nn.BatchNorm2d(d*4)
            self.conv3 = nn.Conv2d(d*4, d*2, 5, 1, 2)
            self.conv3_bn = nn.BatchNorm2d(d*2)
            self.conv4 = nn.Conv2d(d*2, d, 5, 1, 2)
            self.conv4_bn = nn.BatchNorm2d(d)
            self.conv5 = nn.Conv2d(d, 1, kernel_size=7, stride=1, padding=3)
