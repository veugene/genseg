...
def build_model():
    ...
    class cbrcb(nn.Module):
        def __init__(self, in_channels, out_channels):
            ...
            self.conv = convolution(
                ...
                kernel_size=1,
                init='kaiming_normal_')
            self.norm_nlin_conv = norm_nlin_conv(
    ...
    submodel = {
        ...
        'f_common'          : cbrcb(enc_out_shape[0], n_latent),
        'f_residual'        : cbrcb(enc_out_shape[0], n_latent),
        'f_unique'          : cbrcb(enc_out_shape[0], n_latent),
        'g_common'          : lambda x:x,
