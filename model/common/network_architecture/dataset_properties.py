...
class Generic_UNet_SEG_GAN(Generic_UNet):
   """
   same architecture as nn-unet but returning encoder-decoder duo instead of one network.
   """
   ...
   def __init__(self, input_channels, base_num_features, num_classes, num_pool, num_conv_per_stage=2,
      ...
      # MG: up to here nothing really changes.
...
def get_dataset_properties(path):
...
config = get_dataset_properties("")
encoder, decoder = Generic_UNet_SEG_GAN(**config)