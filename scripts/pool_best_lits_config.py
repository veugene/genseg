...
# {'bds3_001LZ_dice100_sum1 (f0.6)': {'1234': -0.82375, '4444': -0.8182499999999999, '8888': -0.81575},
#  'bds3_001LZ_dice100_sum1_rec200 (f0.6)': {'1234': -0.81975, '4444': -0.8262499999999999, '8888': -0.82125},
#  'bds3_001LZ_dice100_sum1_rec200_z5 (f0.6)': {'1234': -0.8225, '4444': -0.82025, '8888': -0.824},
#  'bds3_003LZ_dice100_sum1 (f0.6)': {'1234': -0.8205, '4444': -0.8182499999999999, '8888': -0.8202499999999999}}

for seed in seeds:
    argmax_result = np.argmax([results_avg_across_seeds[sim_name][seed] for sim_name in sim_names])
    final_results[seed] = sim_names[argmax_result]

# {'1234': 'bds3_001LZ_dice100_sum1 (f0.15)',
# '4444': 'bds3_001LZ_dice100_sum1 (f0.15)',
# '8888': 'bds3_001LZ_dice100_sum1 (f0.15)'}
print(final_results)
folds = [0, 1, 2, 3]
